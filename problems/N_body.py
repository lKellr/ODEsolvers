...
masses = np.array([330e3, 0.0553, 0.815, 1.0, 0.107, 317.8, 95.2])
...
initial_speeds = np.array(  # calculation from circular orbit
    [[0.0, 0.0]]
...
x0 = np.hstack([initial_positions.flatten(), masses2 * initial_speeds.flatten()])
...
time_text = ax.text(0.5, 0.9, f"t = 0 yr", transform=ax.transAxes)
